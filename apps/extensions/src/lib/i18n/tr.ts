...
export const tr: typeof en = {
  ...
  subSprout: {
    ...
    growthStagesPerSub: 'Abonelik başına büyüme aşaması:',
    ...
    previewHintChannel: 'Widget {channel} sohbetine bağlanana kadar simüle aboneler gösterilir.',
