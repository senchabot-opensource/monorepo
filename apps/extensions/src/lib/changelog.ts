...
export const CHANGELOG: readonly ChangelogEntry[] = [
  { date: '2026-09-23', key: 'changelog.entries.countdownCancel', widgets: ['countdown'] },
  { date: '2026-09-23', key: 'changelog.entries.goalEmoteIcons', widgets: ['goal'] },
  { date: '2026-09-23', key: 'changelog.entries.countdownEmoteIcons', widgets: ['countdown'] },
  { date: '2026-09-23', key: 'changelog.entries.goalCelebrationName', widgets: ['goal'] },
  { date: '2026-09-23', key: 'changelog.entries.goalEndHide', widgets: ['goal'] },
  ...
  { date: '2026-09-21', key: 'changelog.entries.subathonDynamicRates', widgets: ['subathon'] },
  { date: '2026-09-20', key: 'changelog.entries.scrollHint', widgets: [] },
  { date: '2026-09-20', key: 'changelog.entries.chatFonts', widgets: ['chat-box'] },
  { date: '2026-09-20', key: 'changelog.entries.sproutSaved', widgets: ['sub-sprout'] },
  { date: '2026-09-20', key: 'changelog.entries.countdown', widgets: ['countdown'] },
  { date: '2026-09-20', key: 'changelog.entries.deviceTheme', widgets: [] },
  ...
  {
    date: '2026-09-15',
    key: 'changelog.entries.presets',
    widgets: ['chat-box', 'stream-alerts', 'goal', 'subathon', 'poll', 'raffle'],
  },
  { date: '2026-09-15', key: 'changelog.entries.poll', widgets: ['poll'] },
  { date: '2026-09-15', key: 'changelog.entries.goal', widgets: ['goal'] },
  { date: '2026-09-14', key: 'changelog.entries.streamAlerts', widgets: ['stream-alerts'] },
  { date: '2026-09-14', key: 'changelog.entries.subathon', widgets: ['subathon'] },
  { date: '2026-09-14', key: 'changelog.entries.chatReader', widgets: ['chat-box'] },
  {
    date: '2026-09-14',
    key: 'changelog.entries.chatSilentDrop',
    widgets: ['chat-box', 'emote-wall', 'obs-bridge'],
  },
