...
- `public/og/{home,chat-box,emote-wall,sub-sprout,subathon,stream-alerts,raffle,obs-bridge,guides}.png`: 1200×630
...
the Raffle overlay, Subathon Timer and Stream Alerts fed events over their BroadcastChannels), laid onto `template.html`. Titles and
