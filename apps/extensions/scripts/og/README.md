...
- `public/og/{home,chat-box,emote-wall,sub-sprout,subathon,raffle,obs-bridge,guides}.png`: 1200×630
...
the Raffle overlay and Subathon Timer fed events over their BroadcastChannels), laid onto `template.html`. Titles and
