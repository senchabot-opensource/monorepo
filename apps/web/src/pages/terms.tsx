        ...
        <Stack
          ...
          <Stack width="100%" maxWidth="1440px">
            ...
            <Typography variant="h6" sx={{ paddingTop: "10px" }}>
              ...
              guarantees regarding the performance or functionality of
              Senchabot.
            </Typography>
            <Typography variant="h6" sx={{ paddingTop: "10px" }}>
              2. Senchabot is intended for use in accordance with
              Discord&lsquo;s and Twitch&lsquo;s terms of service. We reserve
              the right to terminate access to Senchabot for users who violate
              these terms.
            </Typography>
            <Typography variant="h6" sx={{ paddingTop: "10px" }}>
            ...
            <Typography variant="h6" sx={{ paddingTop: "10px" }}>
              4. Senchabot may include links to third-party websites or
              services. We are not responsible for the content or functionality
              of these websites or services.
            </Typography>
            <Typography variant="h6" sx={{ paddingTop: "10px" }}>
            ...
            <Typography variant="h6" sx={{ paddingTop: "10px" }}>
              ...
              time. Your continued use of Senchabot after any modifications to
